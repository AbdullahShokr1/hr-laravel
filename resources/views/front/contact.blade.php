            ...
            <div class="container ">
                <div class="row">
                    ...
                    <div class="col-lg-8 offset-lg-2 animate" data-animation="slideDown">
                        ...
                        <form action="{{route('sendcontact')}}" class="black-bg contact-form c-mb-20 c-gutter-20" method="POST"  >
                        @csrf
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="ds form-group has-placeholder">
                                        ...
                                        <input type="text" value="{{old('subject')}}" name="subject" id="subject" class="form-control" placeholder="Subject">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
