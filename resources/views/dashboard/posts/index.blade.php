                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a class="btn btn-primary btn-fw" href="{{route('dashboard.posts.create')}}"> Add Admin </a>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        @foreach($posts as $post)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-warning btn-fw" href="{{route('dashboard.admins.edit',$post->id)}}"> Edit User </a>
                                                </td>
                                                <td>
                                                    <form class="del btn btn-danger" action="{{ route('dashboard.admins.destroy',$post->id) }}" method="post">
                                                        @csrf
                                                        @method('delete')
