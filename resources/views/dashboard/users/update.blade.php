                            ...
                            <div class="card-body">
                                ...
                                @method('put')
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" value="{{$user->name}}" required autofocus class="form-control" id="exampleInputUsername1" placeholder="Username">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Email address</label>
                                        <input type="email" name="email" value="{{$user->email}}" required class="form-control" id="exampleInputEmail1" placeholder="Email">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <a class="btn btn-dark" href="{{route('dashboard.users.index')}}">Cancel</a>
                                </form>
                            </div>
                        </div>
                    </div>
