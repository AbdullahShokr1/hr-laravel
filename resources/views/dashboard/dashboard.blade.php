                                ...
                                <div class="row">
                                    <div class="col-8 col-sm-12 col-xl-8 my-auto">
                                        <div class="d-flex d-sm-block d-md-flex align-items-center">
                                            <h2 class="mb-0">{{$contacts->count()}}</h2>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                                        <i class="icon-lg mdi mdi-account-box-outline text-danger ml-auto"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                                        <i class="icon-lg mdi mdi-briefcase text-success ml-auto"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="preview-list">
                                    @foreach($contacts as $contact)
                                        <div class="preview-item border-bottom">
                                            <div class="preview-thumbnail">
                                                <img src="{{URL::asset('assets/images/faces/face6.jpg')}}" alt="image" class="rounded-circle" />
                                            </div>
                                    ...
                                    @foreach($candidates as $candidates)
                                        <div class="preview-item border-bottom">
                                            ...
                                            <div class="preview-item-content d-flex flex-grow">
                                                <div class="flex-grow">
                                                    <div class="d-flex d-md-block d-xl-flex justify-content-between">
                                                        <h6 class="preview-subject">{{$candidates->name}}</h6>
                                                    </div>
                                                    <p class="text-muted">{{$candidates->comment}}</p>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
