                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{route('dashboard.category.store')}}" method="POST" class="card-body">
                                    @csrf
...
{{--                                <form class="forms-sample" method="POST" action="{{ route('dashboard.category.store') }}">--}}
{{--                                @csrf--}}
{{--                                    <div class="form-group">--}}
{{--                                        <label for="exampleInputUsername1">title</label>--}}
{{--                                        <input type="text" name="title" :value="old('title')" required autofocus class="form-control" id="exampleInputUsername1" placeholder="title">--}}
{{--                                    </div>--}}
{{--                                    <div class="form-group">--}}
{{--                                        <label for="exampleInputUsername2">description</label>--}}
{{--                                        <input type="text" name="description" :value="old('description')" required autofocus class="form-control" id="exampleInputUsername3" placeholder="description">--}}
{{--                                    </div>--}}
{{--                                    <div class="form-group">--}}
{{--                                        <label for="exampleInputUsername3">slug</label>--}}
{{--                                        <input type="text" name="slug" :value="old('slug')" required autofocus class="form-control" id="exampleInputUsername3" placeholder="slug">--}}
{{--                                    </div>--}}
{{--                                    <button type="submit" class="btn btn-primary mr-2">Create</button>--}}
{{--                                    <a class="btn btn-dark" href="{{route('dashboard.category.index')}}">Cancel</a>--}}
{{--                                </form>--}}
                            </div>
                        </div>
                    </div>
