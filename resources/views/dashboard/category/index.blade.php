                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a class="btn btn-primary btn-fw" href="{{route('dashboard.category.create')}}"> Add Admin </a>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        @foreach($categories as $category)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-warning btn-fw" href="{{route('dashboard.category.edit',$category->id)}}"> Edit User </a>
                                                </td>
                                                <td>
                                                    <form class="del btn btn-danger" action="{{ route('dashboard.category.destroy',$category->id) }}" method="post">
                                                        @csrf
                                                        @method('delete')
